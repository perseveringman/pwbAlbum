     ...
     */
     ...
     PwbAlbum.prototype.barrelNewLine = function(boxes,rowHeight) {
        ...
        for (var i = 0; i < boxes.length; i++) {
            ...
            boxes[i].css('height',rowH).css('width',boxW*0.96).css('float','left');
     ...
     * 允许点击图片时全屏浏览图片
     */
    PwbAlbum.prototype.enableFullscreen = function () {
